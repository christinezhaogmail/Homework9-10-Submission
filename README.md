...
An intelligent voice-enabled AI agent that can listen to user queries, process them using LLM (hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M), execute tools (arXiv search and mathematical calculations), and respond with synthesized speech.

## Features

- **Voice Interaction**: Speech-to-Text using OpenAI Whisper
- **Intelligent LLM**: hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M via Ollama with function calling capabilities
- **Tool Execution**:
...
```
User Voice Input → Whisper (STT) → hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M (LLM) → Function Router → Tools
                                                                           ↓
...
- Ollama with hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M model installed
...
# Pull hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M model
...
- **LLM**: hf.co/Christine-HiAiPerf/llama3-8b-qlora-finetuned-Q4_K_M-GGUF:Q4_K_M via Ollama
- **STT**: OpenAI Whisper
